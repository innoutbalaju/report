    ...
    <div className="space-y-8 pb-12 font-sans selection:bg-luxury-accent/30 selection:text-luxury-light">
      ...
      <style dangerouslySetInnerHTML={{__html: `
        @media print {
          ...
          .print\\:hidden, aside, header, button, .print-hide, .absolute.right-2 {
          ...
          * {
          ...
          @page {
            size: A4 landscape;
            margin: 0.1cm 0.15cm !important;
          }

          /* Force ultra-compact spacing inside print canvas container */
          .space-y-4 {
          ...
          /* Adjust header info lines under name */
          .relative.mt-4, .flex.justify-between.items-center.mt-4 {
            margin-top: 1px !important;
            padding-bottom: 1px !important;
          }
          ...
          /* Align text fields left for readability */
          ...
          /* Compact manager note height for print */
          textarea {
          ...
          /* Compact aggregate summary split row */
          .grid.grid-cols-2.border-t.border-black {
